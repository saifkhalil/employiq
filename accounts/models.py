...
class User(AbstractBaseUser,PermissionsMixin):
	...
	photo = models.ImageField(verbose_name="Photo",upload_to='photos',default='photos/default.jpg')
	thumbnail = models.ImageField(verbose_name="Thumbnail image",upload_to='thumbnail', editable=False,blank=True, null=True)
